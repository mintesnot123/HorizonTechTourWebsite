...
>
  <head>
    ...
    <title>New email template 2021-12-29</title>
    <!--[if (mso 16)]>
      <style type="text/css">
        a {
  ...
  >
                                ...
                                <tr style="border-collapse: collapse">
                                  ...
                                  >
                                    <a
                                      ...
                                      "
                                      ><img
                                        src="https://ttbxci.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/51621521206431413.png"
                                        alt
                                        style="
                                          display: block;
                                          border: 0;
                    ...
                    <tr style="border-collapse: collapse">
                      <td
                        style="
                          ...
                          padding-left: 40px;
                          padding-right: 40px;
                          background-image: url('https://ttbxci.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/93491522393929597.png');
                          background-repeat: no-repeat;
                        "
                        align="left"
                        background="https://ttbxci.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/93491522393929597.png"
                      >
                        <table
                          width="100%"
                          cellspacing="0"
                            ...
                            >
                              ...
                              >
                                <tr style="border-collapse: collapse">
                                  ...
                                  >
                                    <img
                                      src="https://ttbxci.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/29241521207598269.jpg"
                                      alt
                                      style="
                                        display: block;
                                        border: 0;
                                    ...
                                    >
                                      <tr style="border-collapse: collapse">
                                        ...
                                        >
                                          <img
                                            title="Facebook"
                                            src="https://ttbxci.stripocdn.email/content/assets/img/social-icons/circle-white/facebook-circle-white.png"
                                            alt="Fb"
                                            width="24"
                                            height="24"
                                            style="
                                        ...
                                        >
                                          <img
                                            title="Twitter"
                                            src="https://ttbxci.stripocdn.email/content/assets/img/social-icons/circle-white/twitter-circle-white.png"
                                            alt="Tw"
                                            width="24"
                                            height="24"
                                            style="
                                        ...
                                        >
                                          <img
                                            title="Instagram"
                                            src="https://ttbxci.stripocdn.email/content/assets/img/social-icons/circle-white/instagram-circle-white.png"
                                            alt="Inst"
                                            width="24"
                                            height="24"
                                            style="
                                        ...
                                        >
                                          <img
                                            title="Linkedin"
                                            src="https://ttbxci.stripocdn.email/content/assets/img/social-icons/circle-white/linkedin-circle-white.png"
                                            alt="In"
                                            width="24"
                                            height="24"
                                            style="
                                ...
                                <tr style="border-collapse: collapse">
                                  ...
                                  >
                                    <p
                                      ...
                                      "
                                    >
                                      This email was sent to you from Company
                                      Email Address
                                    </p>
                                  </td>
                                </tr>
                                ...
                                <tr style="border-collapse: collapse">
                                  ...
                                  >
                                    <a
                                      ...
                                      "
                                      ><img
                                        src="https://ttbxci.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png"
                                        alt
                                        width="125"
                                        style="
                                          display: block;
    ...
    resetPasswordEmailTemplete2: function (url, userName) {
    ...
    contactUsMessage: function (name) {
        return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    contactUsMessageToAdmin: function (name, email, text) {
        return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  ...
  <body>
    ...
    callMeMessageToAdmin: function (name, phoneNumber, email, interest) {
        return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Call Me Message</title>
    <style type="text/css" rel="stylesheet" media="all">
      /* Base ------------------------------ */
      *:not(br):not(tr):not(html) {
        font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;
            ...
            <tr>
              <td class="email-body" width="100%">
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="content-cell">
                      <h1>${`Call me From ${name},`}</h1>                        
                      ${email && `<p><br>Email: ${email} <br></p>`}
                      ${
                          phoneNumber &&
                          `<p><br>Phone Number: ${phoneNumber} <br></p>`
                      }
                      ${
                          interest &&
                          `<p><br>Interested in: ${interest} <br></p>`
                      }                                                                
                      <p>Kindly,<br>${name}</p>                        
                    </td>
                  </tr>
